...
<body>
 ...
 <!--  							<table class="table table-striped">
								...
								<tbody>
									<%
										List<StudentVo> studentList = (List<StudentVo>) session
												.getAttribute("studentList");
										for (StudentVo vo : studentList) {
											out.write("<tr><th>" + vo.getId() + "</th>" + "<th>"
													+ vo.getName() + "</th>" + "<th>" + vo.getCall_cnt()
													+ "</th>" + "<th>" + vo.getReg_dt() + "</th></tr>");
										}
									%>
								...
								<tbody>
									<c:forEach items="${studentList}" var="vo">
										...
										<tr data-id="${vo.id}">
											...
											<th>${vo.name}</th>
											<th>${vo.call_cnt}</th>
											<th><fmt:formatDate value="${vo.reg_dt}"
